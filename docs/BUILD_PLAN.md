...
| 2 | Agent foundation (models, tools, redaction) | Done (`phase/02-agent-core`) |
| 3 | Beginner Home + crypto project intelligence | In progress (`phase/03-home-and-intelligence`) |
